 ...
 * @author Caio
 */
public class CadastroExCli extends javax.swing.JFrame {

    /**
     * Creates new form CadastroLab
     */
    public CadastroExCli() {
        initComponents();
        setIcon();
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Exame Clínico");
        setResizable(false);
...
/*               Usuario u = new Usuario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroExCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroExCli().setVisible(true);
            }
        });
    }
