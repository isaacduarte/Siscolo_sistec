 ...
 * @author CAIO
 */
public class UpCelulasATI extends javax.swing.JFrame {
//
    /**
   ...
   public void cadastroCont(citopatologico cito){
        ...
        jLIdUni.setText(""+cito.getUnidadeSaude().getId());
                    ...
                    if(cito.getCelulasAtipicas().equals(jCEP.getText())){
                        jCEP.setSelected(true);
            
            }else if(cito.getCelulasAtipicas().equals(jCELesao.getText())){
                    jCELesao.setSelected(true);
                if(cito.getAtipiasCelulasEscamosas().equals(jCELesaoAlto.getText())){
                        jCELesaoAlto.setSelected(true);
                }else if(cito.getAtipiasCelulasEscamosas().equals(jCELesaoBaixo.getText())){
                        jCELesaoBaixo.setSelected(true);
                        
                }else if(cito.getAtipiasCelulasEscamosas().equals(jCELesaoaltonao.getText())){
                    jCELesaoaltonao.setSelected(true);
                    }
                else if(cito.getAtipiasCelulasEscamosas().equals(jCEcarcinoma.getText())){
                        jCEcarcinoma.setSelected(true);
                }
                }//aqui ooooo
            
            if(cito.getCelulasAtipicas().equals(jCGPossivelmente.getText())){
                jCGPossivelmente.setSelected(true);
            
            }else if(cito.getCelulasAtipicas().equals(jCGLesao.getText())){
                    jCGLesao.setSelected(true);
                if(cito.getAtipiasCelulasGlandulares().equals(jCGAdenocarcinoma.getText())){
                    jCGAdenocarcinoma.setSelected(true);
                }else if(cito.getAtipiasCelulasGlandulares().equals("Adenocarcinoma Invasor:"+jCGCervical.getText())){
                    jCGCervical.setSelected(true);
                
                }else if(cito.getAtipiasCelulasGlandulares().equals("Adenocarcinoma Invasor:"+jCGEndometria.getText())){
                    jCELesaoaltonao.setSelected(true);
                    }
                else if(cito.getAtipiasCelulasGlandulares().equals("Adenocarcinoma Invasor:"+jCGSem.getText())){
                        jCGSem.setSelected(true);
                }
                }
            
            
            if(cito.getCelulasAtipicas().equals(jCIPossivelmente.getText())){
               jCIPossivelmente.setSelected(true);
            
            }else if(cito.getCelulasAtipicas().equals(jCILesao.getText())){
                    jCILesao.setSelected(true);
                if(cito.getOrigemIndefinida().equals(jCIPresenca.getText())){
                    jCGAdenocarcinoma.setSelected(true);
                }else{
                    jCIOutras.setSelected(true);
                    jTOutras.setText(cito.getOrigemIndefinida());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpCelulasATI().setVisible(true);
            }
        });
    }
