 ...
 * @author Caio
 */
public class UpMicrobio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IconesNovos/cancelar.png"))); // NOI18N
        jLabel1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel1MouseClicked(evt);
            }
        });
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 280, -1, -1));
    ...
    if(!JCBActinomy.isSelected() && !JCBBacilos.isSelected() && !JCBCandida.isSelected() && !JCBCocos.isSelected()
     ...
     cito.setMicrobiologia(JCBBacilos.getText());
        ...
        int i = Integer.parseInt(jLId.getText());
            ...
            UpCelulasATI prin = new UpCelulasATI();
   ...
   public void cadastroCont(citopatologico cito){
        ...
        if(cito.getMicrobiologia().equals(JCBActinomy.getText())){
         JCBActinomy.setSelected(true);
         
     }else if(cito.getMicrobiologia().equals(JCBBacilos.getText())){
        JCBBacilos.setSelected(true);
     }else if(cito.getMicrobiologia().equals(JCBCandida.getText())){
         JCBCandida.setSelected(true);
     }else if(cito.getMicrobiologia().equals(JCBCocos.getText())){
        JCBCocos.setSelected(true);
     }else if(cito.getMicrobiologia().equals(JCBEfeito.getText())){
         JCBEfeito.setSelected(true);
     }else if(cito.getMicrobiologia().equals(JCBLactoba.getText())){
         JCBLactoba.setSelected(true);
     }else if(cito.getMicrobiologia().equals(JCBSugestivo.getText())){
         JCBSugestivo.setSelected(true);
     }else if(cito.getMicrobiologia().equals(JCBTrichomonas.getText())){
         JCBTrichomonas.setSelected(true);
     }else{
         JCBOutrosB.setSelected(true);
         JTOutrosB.setText(cito.getMicrobiologia());
     }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpMicrobio().setVisible(true);
            }
        });
    }
