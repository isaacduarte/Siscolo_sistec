...
public class CadastroBAtiva extends javax.swing.JFrame {
    ...
    public CadastroBAtiva() {
        ...
        naoLocalizada.setVisible(false);
         jCheckBoxssnMudou.setVisible(false);
        jCheckBoxSSNsem.setVisible(false);
        jCheckBoxSSNoutros.setVisible(false);
    ...
    private void CadastrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CadastrarMouseClicked
        if(boxnomePaciente.equals("Escolha um  Paciente")){
            JOptionPane.showMessageDialog(null, "Escolha um Paciente");
        }else if(jTextFieldDataExame.equals("")){
