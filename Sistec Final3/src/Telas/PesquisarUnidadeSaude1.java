 ...
 * @author Caio
 */
public class PesquisarUnidadeSaude1 extends javax.swing.JFrame {
    ...
    public void  preechendoTabelaUnidadeSaude(){
    
             UnidadeSaudeDao dao=new UnidadeSaudeDao();
            List<UnidadeSaude> us = dao.pesquisaId();
          DefaultTableModel dtmUnidadeSaude = (DefaultTableModel) jTable1.getModel();
          if(us !=null){
            for(UnidadeSaude u: us){
            Object[] dados={u.getId(), u.getCNESUS(), u.getUnidadeSaude(), u.getNProtocolo(), u.getMunicipio(),
                u.getUF(), u.getProntuario()};
            dtmUnidadeSaude.addRow(dados);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "CNES Unidade Saude", "Unidade Saude", "Protocolo", "Municipio", "UF", "Prontuario"
            }
        ) {
 ...
 JOptionPane.showMessageDialog(this, "Obs: Só Podera Apagar a Unidade de Saúde que não estiver Vinculado a Algum Exame ");
                    ...
                    dao.remover(UnidadeSaude.class, id);
                      System.out.println(us);
                    dtmUs.removeRow(jTable1.getSelectedRow());
                  }else{
...
JOptionPane.showMessageDialog(this, "Obs: Para Apagar a Unidade de Saúde Precissa Apagar seu Vinculos com Os Exames ");
    ...
    private void Novo1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Novo1MouseClicked
        // TODO add your handling code here:
        dispose();
        CadastroUnid us = new CadastroUnid();
        us.setVisible(true);
...
TableRowSorter trs ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisarUnidadeSaude1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PesquisarUnidadeSaude1().setVisible(true);
            }
        });
    }
